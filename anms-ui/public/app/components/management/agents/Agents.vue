<template>
  <div>
    <b-row>
      <b-col offset="2" cols="8">
        ...
        <b-table
          ...
          bordered
        >
          <template #cell(agent_id_string)="{ item }">
            <h5 @click="goToAgentDetails(item.registered_agents_id)">
              {{ item.agent_id_string }}
            </h5>
          </template>
        </b-table>
      </b-col>
    ...
    <input name="node" v-model="node" placeholder="ipn:2.2" />
    ...
    <b-dropdown id="dropdown-1" dropright text="Manage agent" class="m-md-2">
      <b-dropdown-item-button disabled @click="onClickDeregister(nodeMan)"
        >De-register</b-dropdown-item-button
      >
      ...
      >
        ...
        <b-form-group>
          ...
          <select v-model="selected">
            <option disabled value="">Which Report?</option>
        ...
        <b-dropdown-item-button
          @click="onClickSendTBR(nodeMan, start, period, countTBR, selected)"
          >Send Time Based Rule</b-dropdown-item-button
        >
      </b-form-group>
      <b-dropdown-divider></b-dropdown-divider>
      ...
      <b-dropdown-form>
        ...
        >
          <b-form-input
            id="dropdown-form-raw"
            v-model="raw"
            size="sm"
            placeholder="0x0"
          ></b-form-input>
          <b-dropdown-item-button @click="onClickSendRawCommand(nodeMan, raw)"
            >Send Raw Command</b-dropdown-item-button
          >
        </b-form-group>
      </b-dropdown-form>
      <b-dropdown-divider></b-dropdown-divider>
      <b-dropdown-item-button @click="onClickPrintAgentReports(nodeMan)"
        >Print Agent Reports</b-dropdown-item-button
      >
      <b-dropdown-item-button
        disabled
        @click="onClickWriteAgentReportstofile(nodeMan)"
        >Write Agent Reports to file
      </b-dropdown-item-button>
      <b-dropdown-item-button @click="onClickClearAgentReports(nodeMan)"
        >Clear Agent Reports
      </b-dropdown-item-button>
      <b-dropdown-item-button @click="onClickClearAgentTables(nodeMan)"
        >Clear Agent Tables
      </b-dropdown-item-button>
      <b-dropdown-divider></b-dropdown-divider>
    </b-dropdown>
