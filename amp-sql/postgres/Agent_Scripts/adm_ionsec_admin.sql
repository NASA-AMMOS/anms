...
ion_ionsecadmin_meta_name integer;
ion_ionsecadmin_meta_name_did integer;
ion_ionsecadmin_meta_namespace integer;
ion_ionsecadmin_meta_namespace_did integer;
ion_ionsecadmin_meta_version integer;
ion_ionsecadmin_meta_version_did integer;
ion_ionsecadmin_meta_organization integer;
ion_ionsecadmin_meta_organization_did integer;
ion_ionsecadmin_tblt_ltp_rx_rules integer;
tbl_tnvc_id integer;
tnvc_entry integer;
ion_ionsecadmin_tblt_ltp_rx_rules_did integer;
ion_ionsecadmin_tblt_ltp_tx_rules integer;
ion_ionsecadmin_tblt_ltp_tx_rules_did integer;
ion_ionsecadmin_ctrl_key_add integer;
fp_spec_id integer;
r_fp_ent integer;
ion_ionsecadmin_ctrl_key_add_did integer;
ion_ionsecadmin_ctrl_key_change integer;
ion_ionsecadmin_ctrl_key_change_did integer;
ion_ionsecadmin_ctrl_key_del integer;
ion_ionsecadmin_ctrl_key_del_did integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_add integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_add_did integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_change integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_change_did integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_del integer;
ion_ionsecadmin_ctrl_ltp_rx_rule_del_did integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_add integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_add_did integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_change integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_change_did integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_del integer;
ion_ionsecadmin_ctrl_ltp_tx_rule_del_did integer;
ion_ionsecadmin_ctrl_list_keys integer;
ion_ionsecadmin_ctrl_list_keys_did integer;
ion_ionsecadmin_ctrl_list_ltp_rx_rules integer;
ion_ionsecadmin_ctrl_list_ltp_rx_rules_did integer;
ion_ionsecadmin_ctrl_list_ltp_tx_rules integer;
ion_ionsecadmin_ctrl_list_ltp_tx_rules_did integer;
begin
