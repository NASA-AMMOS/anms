...
$do$
DECLARE tnvc_id INT;
DECLARE adm_enum integer  := 1;
DECLARE amp_namespace_id integer := 7;

DECLARE agent_meta_version integer;
DECLARE agent_meta_version_did integer;
DECLARE agent_meta_organization integer;
DECLARE agent_meta_organization_did integer;
DECLARE agent_edd_num_rpt_tpls integer;
DECLARE agent_edd_num_rpt_tpls_did integer;
DECLARE agent_edd_num_rpt_tpls_aid integer;
DECLARE agent_edd_num_tbl_tpls integer;
DECLARE agent_edd_num_tbl_tpls_did integer;
DECLARE agent_edd_num_tbl_tpls_aid integer;
DECLARE agent_edd_sent_reports integer;
DECLARE agent_edd_sent_reports_did integer;
DECLARE agent_edd_sent_reports_aid integer;
DECLARE agent_edd_num_tbr integer;
DECLARE agent_edd_num_tbr_did integer;
DECLARE agent_edd_num_tbr_aid integer;
DECLARE agent_edd_run_tbr integer;
DECLARE agent_edd_run_tbr_did integer;
DECLARE agent_edd_run_tbr_aid integer;
DECLARE agent_edd_num_sbr integer;
DECLARE agent_edd_num_sbr_did integer;
DECLARE agent_edd_num_sbr_aid integer;
DECLARE agent_edd_run_sbr integer;
DECLARE agent_edd_run_sbr_did integer;
DECLARE agent_edd_run_sbr_aid integer;
DECLARE agent_edd_num_const integer;
DECLARE agent_edd_num_const_did integer;
DECLARE agent_edd_num_const_aid integer;
DECLARE agent_edd_num_var integer;
DECLARE agent_edd_num_var_did integer;
DECLARE agent_edd_num_var_aid integer;
DECLARE agent_edd_num_macros integer;
DECLARE agent_edd_num_macros_did integer;
DECLARE agent_edd_num_macros_aid integer;
DECLARE agent_edd_run_macros integer;
DECLARE agent_edd_run_macros_did integer;
DECLARE agent_edd_run_macros_aid integer;
DECLARE agent_edd_num_controls integer;
DECLARE agent_edd_num_controls_did integer;
DECLARE agent_edd_num_controls_aid integer;
DECLARE agent_edd_run_controls integer;
DECLARE agent_edd_run_controls_did integer;
DECLARE agent_edd_run_controls_aid integer;
DECLARE agent_edd_cur_time integer;
DECLARE agent_edd_cur_time_did integer;
DECLARE agent_edd_cur_time_aid integer;
DECLARE agent_op_plusint integer;
DECLARE op_tnvc_id integer;
DECLARE tnvc_entry1 integer;
DECLARE tnvc_entry2 integer;
DECLARE agent_op_plusint_did integer;
DECLARE agent_op_plusuint integer;
DECLARE agent_op_plusuint_did integer;
DECLARE agent_op_plusvast integer;
DECLARE agent_op_plusvast_did integer;
DECLARE agent_op_plusuvast integer;
DECLARE agent_op_plusuvast_did integer;
DECLARE agent_op_plusreal32 integer;
DECLARE agent_op_plusreal32_did integer;
DECLARE agent_op_plusreal64 integer;
DECLARE agent_op_plusreal64_did integer;
DECLARE agent_op_minusint integer;
DECLARE agent_op_minusint_did integer;
DECLARE agent_op_minusuint integer;
DECLARE agent_op_minusuint_did integer;
DECLARE agent_op_minusvast integer;
DECLARE agent_op_minusvast_did integer;
DECLARE agent_op_minusuvast integer;
DECLARE agent_op_minusuvast_did integer;
DECLARE agent_op_minusreal32 integer;
DECLARE agent_op_minusreal32_did integer;
DECLARE agent_op_minusreal64 integer;
DECLARE agent_op_minusreal64_did integer;
DECLARE agent_op_multint integer;
DECLARE agent_op_multint_did integer;
DECLARE agent_op_multuint integer;
DECLARE agent_op_multuint_did integer;
DECLARE agent_op_multvast integer;
DECLARE agent_op_multvast_did integer;
DECLARE agent_op_multuvast integer;
DECLARE agent_op_multuvast_did integer;
DECLARE agent_op_multreal32 integer;
DECLARE agent_op_multreal32_did integer;
DECLARE agent_op_multreal64 integer;
DECLARE agent_op_multreal64_did integer;
DECLARE agent_op_divint integer;
DECLARE agent_op_divint_did integer;
DECLARE agent_op_divuint integer;
DECLARE agent_op_divuint_did integer;
DECLARE agent_op_divvast integer;
DECLARE agent_op_divvast_did integer;
DECLARE agent_op_divuvast integer;
DECLARE agent_op_divuvast_did integer;
DECLARE agent_op_divreal32 integer;
DECLARE agent_op_divreal32_did integer;
DECLARE agent_op_divreal64 integer;
DECLARE agent_op_divreal64_did integer;
DECLARE agent_op_modint integer;
DECLARE agent_op_modint_did integer;
DECLARE agent_op_moduint integer;
DECLARE agent_op_moduint_did integer;
DECLARE agent_op_modvast integer;
DECLARE agent_op_modvast_did integer;
DECLARE agent_op_moduvast integer;
DECLARE agent_op_moduvast_did integer;
DECLARE agent_op_modreal32 integer;
DECLARE agent_op_modreal32_did integer;
DECLARE agent_op_modreal64 integer;
DECLARE agent_op_modreal64_did integer;
DECLARE agent_op_expint integer;
DECLARE agent_op_expint_did integer;
DECLARE agent_op_expuint integer;
DECLARE agent_op_expuint_did integer;
DECLARE agent_op_expvast integer;
DECLARE agent_op_expvast_did integer;
DECLARE agent_op_expuvast integer;
DECLARE agent_op_expuvast_did integer;
DECLARE agent_op_expreal32 integer;
DECLARE agent_op_expreal32_did integer;
DECLARE agent_op_expreal64 integer;
DECLARE agent_op_expreal64_did integer;
DECLARE agent_op_bitand integer;
DECLARE agent_op_bitand_did integer;
DECLARE agent_op_bitor integer;
DECLARE agent_op_bitor_did integer;
DECLARE agent_op_bitxor integer;
DECLARE agent_op_bitxor_did integer;
DECLARE agent_op_bitnot integer;
DECLARE agent_op_bitnot_did integer;
DECLARE agent_op_logand integer;
DECLARE agent_op_logand_did integer;
DECLARE agent_op_logor integer;
DECLARE agent_op_logor_did integer;
DECLARE agent_op_lognot integer;
DECLARE agent_op_lognot_did integer;
DECLARE agent_op_abs integer;
DECLARE agent_op_abs_did integer;
DECLARE agent_op_lessthan integer;
DECLARE agent_op_lessthan_did integer;
DECLARE agent_op_greaterthan integer;
DECLARE agent_op_greaterthan_did integer;
DECLARE agent_op_lessequal integer;
DECLARE agent_op_lessequal_did integer;
DECLARE agent_op_greaterequal integer;
DECLARE agent_op_greaterequal_did integer;
DECLARE agent_op_notequal integer;
DECLARE agent_op_notequal_did integer;
DECLARE agent_op_equal integer;
DECLARE agent_op_equal_did integer;
DECLARE agent_op_bitshiftleft integer;
DECLARE agent_op_bitshiftleft_did integer;
DECLARE agent_op_bitshiftright integer;
DECLARE agent_op_bitshiftright_did integer;
DECLARE agent_op_stor integer;
DECLARE agent_op_stor_did integer;
DECLARE agent_var_num_rules integer;
DECLARE var_ac_id integer;
DECLARE r_ac_entry_id_1 integer;
DECLARE r_ac_entry_id_2 integer;
DECLARE r_ac_entry_id_3 integer;
DECLARE agent_var_num_rules_did integer;
DECLARE agent_tblt_adms integer;
DECLARE tbl_tnvc_id integer;
DECLARE tnvc_entry integer;
DECLARE agent_tblt_adms_did integer;
DECLARE agent_tblt_variables integer;
DECLARE agent_tblt_variables_did integer;
DECLARE agent_tblt_rptts integer;
DECLARE agent_tblt_rptts_did integer;
DECLARE agent_tblt_macros integer;
DECLARE agent_tblt_macros_did integer;
DECLARE agent_tblt_rules integer;
DECLARE agent_tblt_rules_did integer;
DECLARE agent_tblt_tblts integer;
DECLARE agent_tblt_tblts_did integer;
DECLARE agent_rpttpl_full_report integer;
...
DECLARE r_ac_rpt_entry_4 integer;
DECLARE r_ac_rpt_entry_5 integer;
DECLARE r_ac_rpt_entry_6 integer;
DECLARE r_ac_rpt_entry_7 integer;
DECLARE r_ac_rpt_entry_8 integer;
DECLARE r_ac_rpt_entry_9 integer;
DECLARE r_ac_rpt_entry_10 integer;
DECLARE r_ac_rpt_entry_11 integer;
DECLARE r_ac_rpt_entry_12 integer;
DECLARE r_ac_rpt_entry_13 integer;
DECLARE r_ac_rpt_entry_14 integer;
DECLARE r_ac_rpt_entry_15 integer;
DECLARE r_ac_rpt_entry_16 integer;
DECLARE agent_rpttpl_full_report_did integer;
DECLARE agent_rpttpl_full_report_aid integer;
DECLARE agent_ctrl_add_var integer;
DECLARE fp_spec_id integer;
DECLARE r_fp_ent integer;
DECLARE agent_ctrl_add_var_did integer;
DECLARE agent_ctrl_del_var integer;
DECLARE agent_ctrl_del_var_did integer;
DECLARE agent_ctrl_add_rptt integer;
DECLARE agent_ctrl_add_rptt_did integer;
DECLARE agent_ctrl_del_rptt integer;
DECLARE agent_ctrl_del_rptt_did integer;
DECLARE agent_ctrl_desc_rptt integer;
DECLARE agent_ctrl_desc_rptt_did integer;
DECLARE agent_ctrl_gen_rpts integer;
DECLARE agent_ctrl_gen_rpts_did integer;
DECLARE agent_ctrl_gen_tbls integer;
DECLARE agent_ctrl_gen_tbls_did integer;
DECLARE agent_ctrl_add_macro integer;
DECLARE agent_ctrl_add_macro_did integer;
DECLARE agent_ctrl_del_macro integer;
DECLARE agent_ctrl_del_macro_did integer;
DECLARE agent_ctrl_desc_macro integer;
DECLARE agent_ctrl_desc_macro_did integer;
DECLARE agent_ctrl_add_tbr integer;
DECLARE agent_ctrl_add_tbr_did integer;
DECLARE agent_ctrl_add_sbr integer;
DECLARE agent_ctrl_add_sbr_did integer;
DECLARE agent_ctrl_del_rule integer;
DECLARE agent_ctrl_del_rule_did integer;
DECLARE agent_ctrl_desc_rule integer;
DECLARE agent_ctrl_desc_rule_did integer;
DECLARE agent_ctrl_store_var integer;
DECLARE agent_ctrl_store_var_did integer;
DECLARE agent_ctrl_reset_counts integer;
DECLARE agent_ctrl_reset_counts_did integer;
DECLARE agent_cnst_amp_epoch integer;
DECLARE agent_cnst_amp_epoch_did integer;
-- #META
DECLARE agent_meta_name integer; 
DECLARE agent_meta_name_did integer;
DECLARE agent_meta_namespace_did integer;
DECLARE agent_meta_namespace integer;
BEGIN
...
-- #VAR
raise notice 'Value: %',agent_edd_num_tbr_did;
-- create ac for expression
CALL SP__insert_ac_id(3, 'ac for the expression used by agent_var_num_rules', var_ac_id);
CALL SP__insert_ac_actual_entry(var_ac_id, agent_edd_num_tbr_aid, 1, r_ac_entry_id_1 );
CALL SP__insert_ac_actual_entry(var_ac_id, agent_edd_num_sbr_aid, 2, r_ac_entry_id_2 );
...
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_rpt_tpls_aid, 3, r_ac_rpt_entry_3);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_tbl_tpls_aid, 4, r_ac_rpt_entry_4);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_sent_reports_aid, 5, r_ac_rpt_entry_5);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_tbr_aid, 6, r_ac_rpt_entry_6);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_run_tbr_aid, 7, r_ac_rpt_entry_7);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_sbr_aid, 8, r_ac_rpt_entry_8);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_run_sbr_aid, 9, r_ac_rpt_entry_9);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_const_aid, 10, r_ac_rpt_entry_10);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_var_aid, 11, r_ac_rpt_entry_11);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_macros_aid, 12, r_ac_rpt_entry_12);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_run_macros_aid, 13, r_ac_rpt_entry_13);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_num_controls_aid, 14, r_ac_rpt_entry_14);
CALL SP__insert_ac_actual_entry(rptt_ac_id, agent_edd_run_controls_aid, 15, r_ac_rpt_entry_15);
