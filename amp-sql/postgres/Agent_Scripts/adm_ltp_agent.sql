...
ltp_agent_meta_name integer;
ltp_agent_meta_name_did integer;
ltp_agent_meta_namespace integer;
ltp_agent_meta_namespace_did integer;
ltp_agent_meta_version integer;
ltp_agent_meta_version_did integer;
ltp_agent_meta_organization integer;
ltp_agent_meta_organization_did integer;
ltp_agent_edd_span_remote_engine_nbr integer;
ltp_agent_edd_span_remote_engine_nbr_fp integer;
r_fp_ent integer;
ltp_agent_edd_span_remote_engine_nbr_did integer;
ltp_agent_edd_span_cur_expt_sess integer;
ltp_agent_edd_span_cur_expt_sess_fp integer;
ltp_agent_edd_span_cur_expt_sess_did integer;
ltp_agent_edd_span_cur_out_seg integer;
ltp_agent_edd_span_cur_out_seg_fp integer;
ltp_agent_edd_span_cur_out_seg_did integer;
ltp_agent_edd_span_cur_imp_sess integer;
ltp_agent_edd_span_cur_imp_sess_fp integer;
ltp_agent_edd_span_cur_imp_sess_did integer;
ltp_agent_edd_span_cur_in_seg integer;
ltp_agent_edd_span_cur_in_seg_fp integer;
ltp_agent_edd_span_cur_in_seg_did integer;
ltp_agent_edd_span_reset_time integer;
ltp_agent_edd_span_reset_time_fp integer;
ltp_agent_edd_span_reset_time_did integer;
ltp_agent_edd_span_out_seg_q_cnt integer;
ltp_agent_edd_span_out_seg_q_cnt_fp integer;
ltp_agent_edd_span_out_seg_q_cnt_did integer;
ltp_agent_edd_span_out_seg_q_bytes integer;
ltp_agent_edd_span_out_seg_q_bytes_fp integer;
ltp_agent_edd_span_out_seg_q_bytes_did integer;
ltp_agent_edd_span_out_seg_pop_cnt integer;
ltp_agent_edd_span_out_seg_pop_cnt_fp integer;
ltp_agent_edd_span_out_seg_pop_cnt_did integer;
ltp_agent_edd_span_out_seg_pop_bytes integer;
ltp_agent_edd_span_out_seg_pop_bytes_fp integer;
ltp_agent_edd_span_out_seg_pop_bytes_did integer;
ltp_agent_edd_span_out_ckpt_xmit_cnt integer;
ltp_agent_edd_span_out_ckpt_xmit_cnt_fp integer;
ltp_agent_edd_span_out_ckpt_xmit_cnt_did integer;
ltp_agent_edd_span_out_pos_ack_rx_cnt integer;
ltp_agent_edd_span_out_pos_ack_rx_cnt_fp integer;
ltp_agent_edd_span_out_pos_ack_rx_cnt_did integer;
ltp_agent_edd_span_out_neg_ack_rx_cnt integer;
ltp_agent_edd_span_out_neg_ack_rx_cnt_fp integer;
ltp_agent_edd_span_out_neg_ack_rx_cnt_did integer;
ltp_agent_edd_span_out_cancel_rx_cnt integer;
ltp_agent_edd_span_out_cancel_rx_cnt_fp integer;
ltp_agent_edd_span_out_cancel_rx_cnt_did integer;
ltp_agent_edd_span_out_ckpt_rexmit_cnt integer;
ltp_agent_edd_span_out_ckpt_rexmit_cnt_fp integer;
ltp_agent_edd_span_out_ckpt_rexmit_cnt_did integer;
ltp_agent_edd_span_out_cancel_xmit_cnt integer;
ltp_agent_edd_span_out_cancel_xmit_cnt_fp integer;
ltp_agent_edd_span_out_cancel_xmit_cnt_did integer;
ltp_agent_edd_span_out_complete_cnt integer;
ltp_agent_edd_span_out_complete_cnt_fp integer;
ltp_agent_edd_span_out_complete_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_red_cnt integer;
ltp_agent_edd_span_in_seg_rx_red_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_red_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_red_bytes integer;
ltp_agent_edd_span_in_seg_rx_red_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_red_bytes_did integer;
ltp_agent_edd_span_in_seg_rx_green_cnt integer;
ltp_agent_edd_span_in_seg_rx_green_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_green_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_green_bytes integer;
ltp_agent_edd_span_in_seg_rx_green_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_green_bytes_did integer;
ltp_agent_edd_span_in_seg_rx_redundant_cnt integer;
ltp_agent_edd_span_in_seg_rx_redundant_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_redundant_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_redundant_bytes integer;
ltp_agent_edd_span_in_seg_rx_redundant_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_redundant_bytes_did integer;
ltp_agent_edd_span_in_seg_rx_mal_cnt integer;
ltp_agent_edd_span_in_seg_rx_mal_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_mal_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_mal_bytes integer;
ltp_agent_edd_span_in_seg_rx_mal_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_mal_bytes_did integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_cnt integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_bytes integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_bytes_did integer;
ltp_agent_edd_span_in_seg_rx_unk_client_cnt integer;
ltp_agent_edd_span_in_seg_rx_unk_client_cnt_fp integer;
ltp_agent_edd_span_in_seg_rx_unk_client_cnt_did integer;
ltp_agent_edd_span_in_seg_rx_unk_client_bytes integer;
ltp_agent_edd_span_in_seg_rx_unk_client_bytes_fp integer;
ltp_agent_edd_span_in_seg_rx_unk_client_bytes_did integer;
ltp_agent_edd_span_in_seg_stray_cnt integer;
ltp_agent_edd_span_in_seg_stray_cnt_fp integer;
ltp_agent_edd_span_in_seg_stray_cnt_did integer;
ltp_agent_edd_span_in_seg_stray_bytes integer;
ltp_agent_edd_span_in_seg_stray_bytes_fp integer;
ltp_agent_edd_span_in_seg_stray_bytes_did integer;
ltp_agent_edd_span_in_seg_miscolor_cnt integer;
ltp_agent_edd_span_in_seg_miscolor_cnt_fp integer;
ltp_agent_edd_span_in_seg_miscolor_cnt_did integer;
ltp_agent_edd_span_in_seg_miscolor_bytes integer;
ltp_agent_edd_span_in_seg_miscolor_bytes_fp integer;
ltp_agent_edd_span_in_seg_miscolor_bytes_did integer;
ltp_agent_edd_span_in_seg_closed_cnt integer;
ltp_agent_edd_span_in_seg_closed_cnt_fp integer;
ltp_agent_edd_span_in_seg_closed_cnt_did integer;
ltp_agent_edd_span_in_seg_closed_bytes integer;
ltp_agent_edd_span_in_seg_closed_bytes_fp integer;
ltp_agent_edd_span_in_seg_closed_bytes_did integer;
ltp_agent_edd_span_in_ckpt_rx_cnt integer;
ltp_agent_edd_span_in_ckpt_rx_cnt_fp integer;
ltp_agent_edd_span_in_ckpt_rx_cnt_did integer;
ltp_agent_edd_span_in_pos_ack_tx_cnt integer;
ltp_agent_edd_span_in_pos_ack_tx_cnt_fp integer;
ltp_agent_edd_span_in_pos_ack_tx_cnt_did integer;
ltp_agent_edd_span_in_neg_ack_tx_cnt integer;
ltp_agent_edd_span_in_neg_ack_tx_cnt_fp integer;
ltp_agent_edd_span_in_neg_ack_tx_cnt_did integer;
ltp_agent_edd_span_in_cancel_tx_cnt integer;
ltp_agent_edd_span_in_cancel_tx_cnt_fp integer;
ltp_agent_edd_span_in_cancel_tx_cnt_did integer;
ltp_agent_edd_span_in_ack_retx_cnt integer;
ltp_agent_edd_span_in_ack_retx_cnt_fp integer;
ltp_agent_edd_span_in_ack_retx_cnt_did integer;
ltp_agent_edd_span_in_cancel_rx_cnt integer;
ltp_agent_edd_span_in_cancel_rx_cnt_fp integer;
ltp_agent_edd_span_in_cancel_rx_cnt_did integer;
ltp_agent_edd_span_in_complete_cnt integer;
ltp_agent_edd_span_in_complete_cnt_fp integer;
ltp_agent_edd_span_in_complete_cnt_did integer;
ltp_agent_tblt_engines integer;
tbl_tnvc_id integer;
tnvc_entry integer;
ltp_agent_tblt_engines_did integer;
ltp_agent_rpttpl_endpointreport integer;
fp_spec_id integer;
ap_spec_id integer;
ltp_agent_edd_span_remote_engine_nbr_aid_ltp_span_1 integer;
ltp_agent_edd_span_cur_expt_sess_aid_ltp_span_1 integer;
ltp_agent_edd_span_cur_out_seg_aid_ltp_span_1 integer;
ltp_agent_edd_span_cur_imp_sess_aid_ltp_span_1 integer;
ltp_agent_edd_span_cur_in_seg_aid_ltp_span_1 integer;
ltp_agent_edd_span_reset_time_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_seg_q_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_seg_q_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_seg_pop_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_seg_pop_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_ckpt_xmit_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_pos_ack_rx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_neg_ack_rx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_cancel_rx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_ckpt_rexmit_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_cancel_xmit_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_out_complete_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_red_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_red_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_green_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_green_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_redundant_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_redundant_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_mal_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_mal_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_unk_sender_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_unk_client_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_rx_unk_client_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_stray_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_stray_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_miscolor_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_miscolor_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_closed_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_seg_closed_bytes_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_ckpt_rx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_pos_ack_tx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_neg_ack_tx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_cancel_tx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_ack_retx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_cancel_rx_cnt_aid_ltp_span_1 integer;
ltp_agent_edd_span_in_complete_cnt_aid_ltp_span_1 integer;
rptt_ac_id integer;
...
r_ac_rpt_entry_30 integer;
r_ac_rpt_entry_31 integer;
r_ac_rpt_entry_32 integer;
r_ac_rpt_entry_33 integer;
r_ac_rpt_entry_34 integer;
r_ac_rpt_entry_35 integer;
r_ac_rpt_entry_36 integer;
r_ac_rpt_entry_37 integer;
r_ac_rpt_entry_38 integer;
r_ac_rpt_entry_39 integer;
r_ac_rpt_entry_40 integer;
r_ac_rpt_entry_41 integer;
r_ac_rpt_entry_42 integer;
ltp_agent_rpttpl_endpointreport_did integer;
ltp_agent_rpttpl_endpointreport_aid integer;
ltp_agent_ctrl_reset integer;
ltp_agent_ctrl_reset_did integer;
BEGIN
